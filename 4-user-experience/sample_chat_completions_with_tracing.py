...
def chat_completion_with_function_call(token_provider, endpoint):
    import json
...
def main():
    ...
    try:
        ...
        print("Missing environment variable 'AZURE_INFERENCE_ENDPOINT'")
        print("Set them before running this sample.")
        exit()

    chat_completion_with_function_call(credential, endpoint)
